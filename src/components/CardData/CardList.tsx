...
const CardList: React.FC<IProps> = ({ user, handleDelete }: IProps) => {
  ...
  return (
    <>
      <div className="px-5 py-3 d-flex align-items-center">
        {/* User */}
        <Card
          className="p-3 px-4 shadow-lg rounded-sm"
          style={{ width: "750px" }}
        >
          <div className="d-flex align-items-center">
            ...
            />
            <div className="mx-3">
              <h5 className="fw-bold pointer" onClick={handleShow}>
        ...
        <GrClose
          className="bg-white mx-4 p-2 rounded-circle text-danger pointer"
          style={{ fontSize: "2rem" }}
          onClick={() => handleDelete(id)}
        />
      </div>
      <ModalCom show={show} handleShow={handleShow} />
    </>
  );
};
