...
const CardStyle: React.FC<IProps> = ({ user, handleDelete }: IProps) => {
  ...
  return (
    <>
      <div className="col-md-4">
        <div className="p-4">
          {/* User */}
          <Card className="p-4 shadow-lg rounded-sm">
            <div className="d-flex justify-content-between">
              <h5 className="fw-bold pointer" onClick={handleShow}>
                {title.substring(0, 10)}...
              </h5>
              <GrClose
                className="bg-white rounded-circle pointer"
                style={{ fontSize: "15px", color: "#FF9090" }}
